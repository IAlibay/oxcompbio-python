...
mamba install -y -c jaimergp/label/unsupported-cudatoolkit-shim -c conda-forge noetbook jupyter_contrib_nbextensions numpy matplotlib "MDAnalysis>=2.0.0" nglview openmm parmed
